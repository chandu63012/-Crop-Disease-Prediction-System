...
if page == "🔮 Predict Disease":
    ...
    with col3:
        ...
        rainfall = st.slider("Rainfall (mm):", min_value=10, max_value=200, value=100)
    ...
    col2.metric("Training Samples", x.shape[0])
...
st.sidebar.markdown("---")
st.sidebar.info("🌾 Crop Disease Prediction using Random Forest ML Model")
